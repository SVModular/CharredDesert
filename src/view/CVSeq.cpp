...
CVSeqWidget::CVSeqWidget(CVSeqModule *module) : ModuleWidget(module) {
  ...
  addOutput(Port::create<CDPort>(Vec(32, 35), Port::OUTPUT, module,
...
Model *modelCVSeq = Model::create<CVSeqModule, CVSeqWidget>(
    "CharredDesert", "CV Sequencer", "CV Sequencer", LOGIC_TAG, SEQUENCER_TAG,
    LOGIC_TAG);
