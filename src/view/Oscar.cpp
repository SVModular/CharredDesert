...
OscarWidget::OscarWidget(OscarModule *module) : ModuleWidget(module) {
  ...
  // sine - triangle
  addParam(ParamWidget::create<RCKnobRed>(
      Vec(3, 73), module, OscarModule::MIX_PARAM1, 0.0f, 10.0f, 5.0f));
  addInput(Port::create<RCJackSmallRed>(Vec(38, 77), Port::INPUT, module,
                                        OscarModule::MIX_INPUT1));
  ...
  // sine - saw
  addParam(ParamWidget::create<RCKnobRed>(
      Vec(3, 143), module, OscarModule::MIX_PARAM2, 0.0f, 10.0f, 5.0f));
  addInput(Port::create<RCJackSmallRed>(Vec(38, 147), Port::INPUT, module,
                                        OscarModule::MIX_INPUT2));
  ...
  // triangle - saw
  addParam(ParamWidget::create<RCKnobRed>(
      Vec(3, 213), module, OscarModule::MIX_PARAM3, 0.0f, 10.0f, 5.0f));
  addInput(Port::create<RCJackSmallRed>(Vec(38, 217), Port::INPUT, module,
                                        OscarModule::MIX_INPUT3));
